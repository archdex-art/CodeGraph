...
"[project]/src/lib/codeintel/context.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildContext(graph, query, opts = {}) {
    const tokenBudget = opts.tokenBudget ?? 3000;
    const maxSymbols = opts.maxSymbols ?? 24;
    const qe = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$codeintel$2f$query$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QueryEngine"](graph);
    ...
    const add = (s, reason, score)=>{
        const cur = slices.get(s.id);
        if (!cur || score > cur.score) slices.set(s.id, {
            symbol: s,
            reason,
            score
        });
...
function assemble(query, slices) {
    ...
    parts.push(`<!-- Assembled by CodeGraph Graph-RAG: seeds ranked by relevance, expanded along call/containment edges. -->`);
...
"[project]/src/app/api/repos/[id]/intel/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$codeintel$2f$query$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/codeintel/query.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$codeintel$2f$context$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/codeintel/context.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req, { params }) {
    ...
    const qe = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$codeintel$2f$query$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QueryEngine"](g);
    switch(op){
        case "search":
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                results: qe.search(q, 40)
            });
        case "callers":
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                symbol: qe.get(sym),
                results: qe.callers(sym)
            });
        case "callees":
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                symbol: qe.get(sym),
                results: qe.callees(sym)
            });
        case "members":
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                symbol: qe.get(sym),
                results: qe.members(sym)
            });
        case "impact":
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                symbol: qe.get(sym),
                results: qe.impact(sym, 3)
            });
        case "cycles":
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                cycles: qe.cycles()
        ...
        case "deadcode":
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                results: qe.deadCode().slice(0, 100)
            });
        case "hubs":
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                results: qe.hubs(20)
        ...
        case "context":
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$codeintel$2f$context$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildContext"])(g, q));
        default:
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Unknown op: ${op}`
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0vxnjie._.js.map