...
"[project]/src/app/api/fleet/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    const summaries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listRepos"])();
    const nodes = [];
    const edges = [];
    ...
    for (const s of summaries){
        ...
        const r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRepo"])(s.id);
        if (!r) continue;
        nodes.push({
            id: r.id,
            name: r.name,
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(graph);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__0bdqtfa._.js.map