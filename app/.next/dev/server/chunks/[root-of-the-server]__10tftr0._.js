...
"[project]/src/lib/agents/fixers.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function fixerById(id) {
    return FIXERS.find((f)=>f.id === id) ?? null;
}
}),
"[project]/src/lib/agents/executor.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$util__$5b$external$5d$__$28$node$3a$util$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:util [external] (node:util, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$indexer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/indexer.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$agents$2f$fixers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/agents/fixers.ts [app-route] (ecmascript)");
;
;
;
;
...
function walkCode(root) {
    ...
    while(stack.length && out.length < MAX){
        ...
        for (const name of entries){
            ...
            } else if (st.isFile() && CODE[__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].extname(name).toLowerCase()] && st.size < 400_000) {
                out.push(full);
            }
        }
    }
...
function buildDiff(file, before, removed) {
...
const now = ()=>Date.now();
async function executeFixes(repo, githubToken) {
    const steps = [];
    let n = 0;
    const rec = (phase, detail, ok, t0)=>steps.push({
            step: ++n,
            phase,
            detail,
            ok,
    ...
    try {
        ...
        if (repo.sourceType === "git") {
            work = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$indexer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cloneRepo"])(repo.url);
            cleanupWork = true;
            rec("acquire", `Cloned ${repo.url} to sandbox`, true, t);
        } else {
            const src = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$indexer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveLocalDir"])(repo.url);
            work = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["mkdtempSync"])(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join((0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$os__$5b$external$5d$__$28$node$3a$os$2c$__cjs$29$__["tmpdir"])(), "cg-fix-"));
            (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["cpSync"])(src, work, {
                recursive: true,
                filter: (s)=>!SKIP[__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].basename(s)]
            });
            cleanupWork = true;
        ...
        // 2. analyze (before)
        t = now();
        const before = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$indexer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["indexRepo"])(work);
        ...
        for (const full of files){
            const rel = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].relative(work, full).split(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].sep).join("/");
            const ext = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].extname(full).toLowerCase();
            let text;
            try {
                text = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["readFileSync"])(full, "utf8");
            ...
            let lines = original;
            const fileEdits = [];
            for (const fx of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$agents$2f$fixers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FIXERS"]){
                const res = fx.apply({
                    rel,
                    ext,
                    lines
            ...
            if (fileEdits.length) {
                (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["writeFileSync"])(full, lines.join("\n"), "utf8");
                allEdits.push(...fileEdits);
                changed.set(rel, {
                    before: original,
                    removed: new Set(fileEdits.map((e)=>e.line - 1))
                });
            }
        }
        rec("apply", `Applied ${allEdits.length} edit(s) across ${changed.size} file(s)`, true, t);
        if (allEdits.length === 0) {
            if (cleanupWork && work) (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$indexer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cleanup"])(work);
            return {
                ok: true,
                applied: 0,
                filesChanged: 0,
        ...
        t = now();
        const after = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$indexer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["indexRepo"])(work);
        ...
        if (pr && githubToken && repo.sourceType === "git" && work) {
            try {
                const wd = work;
                const runGit = async (args)=>exec("git", args, {
                        cwd: wd
                    });
                await runGit([
                    "checkout",
                ...
                if (m) {
                    ...
                    if (res.ok) {
                        ...
                        pr = {
                            ...pr,
                            diff: `PR Opened successfully: ${data.html_url}\n\n` + pr.diff
                        };
                    }
                }
        ...
        return {
            ...
            pr,
            steps,
            message: verified ? `Verified: ${allEdits.length} fixes applied, Health Score ${before.score} → ${after.score}, issues ${before.issues.length} → ${after.issues.length}.` : "Fixes applied but verification failed (score regressed) — PR withheld."
        };
    } catch (e) {
        const msg = e instanceof Error ? e.message : String(e);
        ...
        return {
            ...
            filesChanged: 0,
            edits: [],
            scoreBefore: repo.score ?? 0,
            scoreAfter: repo.score ?? 0,
            issuesBefore: 0,
            issuesAfter: 0,
            verified: false,
            pr: null,
...
function buildPR(repo, scoreBefore, scoreAfter, edits, filesChanged, diff) {
    const byFixer = new Map();
    for (const e of edits)byFixer.set(e.fixer, (byFixer.get(e.fixer) || 0) + 1);
    const bullets = [
        ...byFixer.entries()
    ].map(([f, c])=>`- \`${f}\`: ${c} edit(s)`).join("\n");
    const body = [
...
"[project]/src/app/api/repos/[id]/fix/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$agents$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/agents/executor.ts [app-route] (ecmascript)");
;
;
;
...
async function POST(req, { params }) {
    ...
    const repo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRepo"])(id);
    if (!repo) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Repo not found"
    }, {
        status: 404
    });
    if (repo.status !== "done") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Repo not indexed yet"
    }, {
        status: 409
    });
    try {
        const body = await req.json().catch(()=>({}));
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$agents$2f$executor$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeFixes"])(repo, body.githubToken);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10tftr0._.js.map