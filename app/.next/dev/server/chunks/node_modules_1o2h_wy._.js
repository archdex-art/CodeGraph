...
"[project]/node_modules/web-tree-sitter/tree-sitter.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

var Module = void 0 !== Module ? Module : {}, TreeSitter = function() {
    var initPromise, document = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : null;
    class Parser {
        constructor(){
            this.initialize();
        }
        ...
        static init(moduleOptions) {
            return initPromise || (Module = Object.assign({}, Module, moduleOptions), initPromise = new Promise((resolveInitPromise)=>{
                var moduleOverrides = Object.assign({}, Module), arguments_ = [], thisProgram = "./this.program", quit_ = (e, t)=>{
                    throw t;
                }, ENVIRONMENT_IS_WEB = "object" == ("TURBOPACK compile-time value", "undefined"), ENVIRONMENT_IS_WORKER = "function" == typeof importScripts, ENVIRONMENT_IS_NODE = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node, scriptDirectory = "", read_, readAsync, readBinary;
                function locateFile(e) {
                    return Module.locateFile ? Module.locateFile(e, scriptDirectory) : scriptDirectory + e;
                }
                if (ENVIRONMENT_IS_NODE) {
                    var fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)"), nodePath = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
                    scriptDirectory = ENVIRONMENT_IS_WORKER ? nodePath.dirname(scriptDirectory) + "/" : ("TURBOPACK compile-time value", "/ROOT/node_modules/web-tree-sitter") + "/", read_ = (e, t)=>(e = isFileURI(e) ? new URL(e) : nodePath.normalize(e), fs.readFileSync(e, t ? void 0 : "utf8")), readBinary = (e)=>{
                        var t = read_(e, !0);
                    ...
                    }, !Module.thisProgram && process.argv.length > 1 && (thisProgram = process.argv[1].replace(/\\/g, "/")), arguments_ = process.argv.slice(2), "undefined" != ("TURBOPACK compile-time value", "object") && (module.exports = Module), quit_ = (e, t)=>{
                ...
                }, Module.preInit) for("function" == typeof Module.preInit && (Module.preInit = [
                    Module.preInit
                ...
                class ParserImpl {
                    ...
                    parse(e, t, _) {
                        if ("string" == typeof e) currentParseCallback = (t, _)=>e.slice(t);
                        else {
                        ...
                        if (_?.includedRanges) {
                            ...
                            let e = r;
                            for(let t = 0; t < s; t++)marshalRange(e, _.includedRanges[t]), e += SIZE_OF_RANGE;
                        }
                    ...
                    getIncludedRanges() {
                        ...
                        if (e > 0) {
                            let s = t;
                            for(let t = 0; t < e; t++)_[t] = unmarshalRange(s), s += SIZE_OF_RANGE;
                            C._free(t);
                        }
                        return _;
                    }
                ...
                class Tree {
                    ...
                    getChangedRanges(e) {
                        ...
                        if (t > 0) {
                            let e = _;
                            for(let _ = 0; _ < t; _++)s[_] = unmarshalRange(e), e += SIZE_OF_RANGE;
                            C._free(_);
                        }
                        return s;
                    }
                ...
                class Node {
                    ...
                    childrenForFieldId(e) {
                        ...
                        if (t > 0) {
                            let e = _;
                            for(let _ = 0; _ < t; _++)s[_] = unmarshalNode(this.tree, e), e += SIZE_OF_NODE;
                            C._free(_);
                        }
                        return s;
                    }
                    ...
                    get children() {
                        if (!this._children) {
                            ...
                            if (this._children = new Array(e), e > 0) {
                                let _ = t;
                                for(let t = 0; t < e; t++)this._children[t] = unmarshalNode(this.tree, _), _ += SIZE_OF_NODE;
                                C._free(t);
                            }
                        }
                    ...
                    get namedChildren() {
                        if (!this._namedChildren) {
                            ...
                            if (this._namedChildren = new Array(e), e > 0) {
                                let _ = t;
                                for(let t = 0; t < e; t++)this._namedChildren[t] = unmarshalNode(this.tree, _), _ += SIZE_OF_NODE;
                                C._free(t);
                            }
                        }
                    ...
                    descendantsOfType(e, t, _) {
                        Array.isArray(e) || (e = [
                            e
                        ]), t || (t = ZERO_POINT), _ || (_ = ZERO_POINT);
                        const s = [], r = this.tree.language.types;
                        for(let t = 0, _ = r.length; t < _; t++)e.includes(r[t]) && s.push(t);
                        const a = C._malloc(SIZE_OF_INT * s.length);
                        for(let e = 0, t = s.length; e < t; e++)setValue(a + e * SIZE_OF_INT, s[e], "i32");
                        ...
                        if (o > 0) {
                            let e = n;
                            for(let t = 0; t < o; t++)l[t] = unmarshalNode(this.tree, e), e += SIZE_OF_NODE;
                        }
                ...
                class Language {
                    ...
                    query(e) {
                        ...
                        if (!s) {
                            const t = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32"), s = getValue(TRANSFER_BUFFER, "i32"), r = UTF8ToString(_, s).length, a = e.substr(r, 100).split("\n")[0];
                            let o, n = a.match(QUERY_WORD_REGEX)[0];
                            switch(t){
                                case 2:
                                ...
                                case 4:
                                    ...
                                    break;
                                case 5:
                                    o = new TypeError(`Bad pattern structure at offset ${r}: '${a}'...`), n = "";
                                    break;
                                default:
                                    o = new SyntaxError(`Bad syntax at offset ${r}: '${a}'...`), n = "";
                            }
                        ...
                        for(let e = 0; e < a; e++){
                            const t = C._ts_query_capture_name_for_id(s, e, TRANSFER_BUFFER), _ = getValue(TRANSFER_BUFFER, "i32");
                            n[e] = UTF8ToString(t, _);
                        }
                        for(let e = 0; e < r; e++){
                            const t = C._ts_query_string_value_for_id(s, e, TRANSFER_BUFFER), _ = getValue(TRANSFER_BUFFER, "i32");
                            l[e] = UTF8ToString(t, _);
                        }
                        const d = new Array(o), u = new Array(o), m = new Array(o), c = new Array(o), w = new Array(o);
                        for(let e = 0; e < o; e++){
                            const t = C._ts_query_predicates_for_pattern(s, e, TRANSFER_BUFFER), _ = getValue(TRANSFER_BUFFER, "i32");
                            c[e] = [], w[e] = [];
                            const r = [];
                            let a = t;
                            for(let t = 0; t < _; t++){
                                ...
                                if (a += SIZE_OF_INT, t === PREDICATE_STEP_TYPE_CAPTURE) r.push({
                                    type: "capture",
                                    name: n[_]
                                });
                                else if (t === PREDICATE_STEP_TYPE_STRING) r.push({
                                    type: "string",
                                    value: l[_]
                                });
                                else if (r.length > 0) {
                                    if ("string" !== r[0].type) throw new Error("Predicates must begin with a literal value");
                                    const t = r[0].value;
                                    let _, s = !0, a = !0;
                                    switch(t){
                                        case "any-not-eq?":
                                        ...
                                        case "any-eq?":
                                        case "eq?":
                                            if (3 !== r.length) throw new Error(`Wrong number of arguments to \`#${t}\` predicate. Expected 2, got ${r.length - 1}`);
                                            if ("capture" !== r[1].type) throw new Error(`First argument of \`#${t}\` predicate must be a capture. Got "${r[1].value}"`);
                                            if (a = !t.startsWith("any-"), "capture" === r[2].type) {
                                                const t = r[1].name, _ = r[2].name;
                                                w[e].push((e)=>{
                                                    const r = [], o = [];
                                                    for (const s of e)s.name === t && r.push(s.node), s.name === _ && o.push(s.node);
                                                    const n = (e, t, _)=>_ ? e.text === t.text : e.text !== t.text;
                                                    return a ? r.every((e)=>o.some((t)=>n(e, t, s))) : r.some((e)=>o.some((t)=>n(e, t, s)));
                                                });
                                            } else {
                                                _ = r[1].name;
                                                const t = r[2].value, o = (e)=>e.text === t, n = (e)=>e.text !== t;
                                                w[e].push((e)=>{
                                                    const t = [];
                                        ...
                                        case "match?":
                                            if (3 !== r.length) throw new Error(`Wrong number of arguments to \`#${t}\` predicate. Expected 2, got ${r.length - 1}.`);
                                            if ("capture" !== r[1].type) throw new Error(`First argument of \`#${t}\` predicate must be a capture. Got "${r[1].value}".`);
                                            if ("string" !== r[2].type) throw new Error(`Second argument of \`#${t}\` predicate must be a string. Got @${r[2].value}.`);
                                            _ = r[1].name;
                                            const o = new RegExp(r[2].value);
                                            a = !t.startsWith("any-"), w[e].push((e)=>{
                                                const t = [];
                                                for (const s of e)s.name === _ && t.push(s.node.text);
                                                const r = (e, t)=>t ? o.test(e) : !o.test(e);
                                                return 0 === t.length ? !s : a ? t.every((e)=>r(e, s)) : t.some((e)=>r(e, s));
                                            });
                                            break;
                                        case "set!":
                                            if (r.length < 2 || r.length > 3) throw new Error(`Wrong number of arguments to \`#set!\` predicate. Expected 1 or 2. Got ${r.length - 1}.`);
                                            if (r.some((e)=>"string" !== e.type)) throw new Error('Arguments to `#set!` predicate must be a strings.".');
                                            d[e] || (d[e] = {}), d[e][r[1].value] = r[2] ? r[2].value : null;
                                            break;
                                        case "is?":
                                        case "is-not?":
                                            if (r.length < 2 || r.length > 3) throw new Error(`Wrong number of arguments to \`#${t}\` predicate. Expected 1 or 2. Got ${r.length - 1}.`);
                                            if (r.some((e)=>"string" !== e.type)) throw new Error(`Arguments to \`#${t}\` predicate must be a strings.".`);
                                            const n = "is?" === t ? u : m;
                                            n[e] || (n[e] = {}), n[e][r[1].value] = r[2] ? r[2].value : null;
                                            break;
                                        case "not-any-of?":
                                            s = !1;
                                        case "any-of?":
                                            if (r.length < 2) throw new Error(`Wrong number of arguments to \`#${t}\` predicate. Expected at least 1. Got ${r.length - 1}.`);
                                            if ("capture" !== r[1].type) throw new Error(`First argument of \`#${t}\` predicate must be a capture. Got "${r[1].value}".`);
                                            for(let e = 2; e < r.length; e++)if ("string" !== r[e].type) throw new Error(`Arguments to \`#${t}\` predicate must be a strings.".`);
                                            _ = r[1].name;
                                            const l = r.slice(2).map((e)=>e.value);
                                            w[e].push((e)=>{
                                                const t = [];
                                                for (const s of e)s.name === _ && t.push(s.node.text);
                                                return 0 === t.length ? !s : t.every((e)=>l.includes(e)) === s;
                                            });
                                            break;
                                        default:
                                            c[e].push({
                    ...
                    static load(e) {
                        ...
                        if (e instanceof Uint8Array) t = Promise.resolve(e);
                            ...
                            if ("undefined" != typeof process && process.versions && process.versions.node) {
                                const e = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
                                t = Promise.resolve(e.readFileSync(_));
                            } else t = fetch(_).then((e)=>e.arrayBuffer().then((t)=>{
                        ...
                        return t.then((e)=>loadWebAssemblyModule(e, {
                            ...
                            const t = Object.keys(e), _ = t.find((e)=>LANGUAGE_FUNCTION_REGEX.test(e) && !e.includes("external_scanner_"));
                ...
                class Query {
                    constructor(e, t, _, s, r, a, o, n){
                        assertInternal(e), this[0] = t, this.captureNames = _, this.textPredicates = s, this.predicates = r, this.setProperties = a, this.assertedProperties = o, this.refutedProperties = n, this.exceededMatchLimit = !1;
                    }
                    delete() {
                    ...
                    matches(e, { startPosition: t = ZERO_POINT, endPosition: _ = ZERO_POINT, startIndex: s = 0, endIndex: r = 0, matchLimit: a = 4294967295, maxStartDepth: o = 4294967295 } = {}) {
                        ...
                        for(let t = 0; t < n; t++){
                            ...
                            c += SIZE_OF_INT;
                            const s = new Array(_);
                            if (c = unmarshalCaptures(this, e.tree, c, s), this.textPredicates[t].every((e)=>e(s))) {
                                u[m] = {
                                    pattern: t,
                                    captures: s
                                };
                    ...
                    captures(e, { startPosition: t = ZERO_POINT, endPosition: _ = ZERO_POINT, startIndex: s = 0, endIndex: r = 0, matchLimit: a = 4294967295, maxStartDepth: o = 4294967295 } = {}) {
                        ...
                        for(let t = 0; t < n; t++){
                            ...
                            if (c += SIZE_OF_INT, m.length = _, c = unmarshalCaptures(this, e.tree, c, m), this.textPredicates[t].every((e)=>e(m))) {
                                const e = m[s], _ = this.setProperties[t];
                                _ && (e.setProperties = _);
                ...
                function unmarshalCaptures(e, t, _, s) {
                    for(let r = 0, a = s.length; r < a; r++){
                        const a = getValue(_, "i32"), o = unmarshalNode(t, _ += SIZE_OF_INT);
                        _ += SIZE_OF_NODE, s[r] = {
                            name: e.captureNames[a],
                            node: o
                        };
                    }
                    return _;
                ...
                function unmarshalNode(e, t = TRANSFER_BUFFER) {
                    ...
                    return n.id = _, n.startIndex = s, n.startPosition = {
                        row: r,
                        column: a
                    }, n[0] = o, n;
                }
...
"object" == ("TURBOPACK compile-time value", "object") && (module.exports = TreeSitter);
}),
...
//# sourceMappingURL=node_modules_1o2h_wy._.js.map