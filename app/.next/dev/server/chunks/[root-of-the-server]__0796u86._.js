...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$web$2d$tree$2d$sitter$2f$tree$2d$sitter$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/web-tree-sitter/tree-sitter.js [app-route] (ecmascript)");
...
async function initTreeSitter() {
    if (parser) return;
    await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$web$2d$tree$2d$sitter$2f$tree$2d$sitter$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].init();
    parser = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$web$2d$tree$2d$sitter$2f$tree$2d$sitter$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]();
    // Resolve paths. In dev this is node_modules. In standalone it should be traced.
    try {
        const tsPath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["resolve"])(process.cwd(), "node_modules/tree-sitter-wasms/out/tree-sitter-typescript.wasm");
        tsLanguage = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$web$2d$tree$2d$sitter$2f$tree$2d$sitter$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].Language.load(tsPath);
    } catch (e) {
        console.warn("Failed to load TS grammar:", e);
    }
    try {
        const pyPath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["resolve"])(process.cwd(), "node_modules/tree-sitter-wasms/out/tree-sitter-python.wasm");
        pyLanguage = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$web$2d$tree$2d$sitter$2f$tree$2d$sitter$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].Language.load(pyPath);
    } catch (e) {
        console.warn("Failed to load PY grammar:", e);
    }
}
...
function computeImportGraph(files) {
    ...
    for (const f of files){
        ...
        byNoExt.set(f.rel, f.rel);
    }
    const fanIn = new Map();
    const importEdges = [];
    for (const f of files){
        const dir = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].posix.dirname(f.rel.split(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].sep).join("/"));
        for (const imp of f.imports){
            const target = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].posix.normalize(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].posix.join(dir, imp)).replace(/^\.\//, "");
            const cand = byNoExt.get(target) || byNoExt.get(target + "/index") || byNoExt.get(target.replace(/\/$/, ""));
            if (cand && cand !== f.rel) {
...
"[project]/src/app/api/index/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        if (localPath) {
            const { jobId, repoId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createIndexJob"])(localPath, "local");
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                jobId,
                repoId
            }, {
        ...
        if (repoUrl) {
            ...
            const { jobId, repoId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createIndexJob"])(repoUrl, "git");
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                jobId,
                repoId
            }, {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Provide repoUrl or localPath"
        }, {
            status: 400
        });
    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0796u86._.js.map