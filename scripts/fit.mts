  ...
  `${JSON.stringify(
    {
      ...
      supersededBy: "docs/design/ADR-009-score-calibration.md",
      targetRetired:
        "Cross-project transfer is not this product's question — CodeGraph indexes one repo deeply (HLD 2.2) and holds its whole history. This scorecard is retained as the measurement that retired the target, and the harness is retargeted to within-repository validation.",
      note: passed
        ? "Criteria met."
